...
def main():
    try:
        ...
        setup.add_box(name = "wall1", pose = [0, -(0.005 + wall_length[1])/2, wall_height / 2], size = [wall_length[0], 0.005, wall_height])
        setup.add_box(name = "wall2", pose = [-(0.005 + wall_length[0])/2, 0, wall_height / 2], size = [0.005, wall_length[1], wall_height])
        setup.add_box(name = "wall3", pose = [0, (0.005 + wall_length[1])/2, wall_height / 2], size = [wall_length[0], 0.005, wall_height])
        setup.add_box(name = "wall4", pose = [(0.005 + wall_length[0])/2, 0, wall_height / 2], size = [0.005, wall_length[1], wall_height])
        setup.add_box(name = "ceiling", pose = [0, 0, wall_height + 0.0025], size = [table_length[0], table_length[1], 0.005])
